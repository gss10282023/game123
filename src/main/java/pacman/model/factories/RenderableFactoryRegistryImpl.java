...
public class RenderableFactoryRegistryImpl implements RenderableFactoryRegistry {
    ...
    public Renderable createRenderable(
        ...
        //create different types of ghosts
        if (factory instanceof GhostFactory) {
            return ((GhostFactory) factory).createRenderable(position, renderableType);
        }


        //create different types of ghost
        if (factory instanceof PelletFactory) {
            return ((PelletFactory) factory).createRenderable(position, renderableType);
        }
